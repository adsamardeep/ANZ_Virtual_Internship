...
#Creating New Column using setDT
...
#Scanning for Missing Values in Txn_Description Column
...
#Combining new rows with the existed one
...
#Detecting Outliers in Monthly Salary Column

boxplot(Salary_Table$monthlysalary)

#Dealing with Outliers in Monthly Salary Column
